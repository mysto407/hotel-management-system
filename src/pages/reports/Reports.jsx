            ...
            <TableBody>
              {Object.entries(revenueByType).sort((a, b) => b[1].total - a[1].total).map(([type, data]) => (
                <TableRow key={type}>
                  ...
                  <TableCell className="text-success">₹{data.paid.toFixed(2)}</TableCell>
              ...
              <TableRow className="font-bold bg-accent hover:bg-accent">
                ...
                <TableCell className="text-success">₹{totals.paid.toFixed(2)}</TableCell>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <Card>
          ...
          <CardContent className="flex justify-around items-center pt-4">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-warning">{paymentStatusBreakdown.partial}</div>
              <Badge variant="warning">Partial</Badge>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-success">{paymentStatusBreakdown.paid}</div>
